...
assert len(list(ElementTree.parse(root / 'sitemap.xml').getroot())) == 22
routes = list((root / 'features').glob('*/index.html')) + list((root / 'learning').glob('*/index.html')) + list((root / 'resources').glob('*/index.html'))
routes += [root / 'learning/index.html', root / 'resources/index.html', root / 'about/index.html', root / 'pricing/index.html', root / 'contact/index.html', root / 'privacy/index.html', root / 'terms/index.html', root / 'security/index.html', root / 'changelog/index.html']
